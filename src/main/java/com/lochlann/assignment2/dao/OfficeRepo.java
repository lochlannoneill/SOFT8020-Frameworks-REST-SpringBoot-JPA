...
public interface OfficeRepo extends JpaRepository<Office, Integer> {
    ...
    @Query("update Office o set o.currentOccupancy = :newCurrentOccupancy where o.id = :id")
    void changeCurrentOccupancy(@Param("id") int id, @Param("newCurrentOccupancy") int newCurrentOccupancy);
    ...
    // ? QUESTION - Should I overload this constructor to allow for departmentId instead of object, for the PATCH request???
