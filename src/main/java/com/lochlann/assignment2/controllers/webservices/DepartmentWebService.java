...
//    // TODO - departmentDtoMapper.toCollectionModel()
//    // * GET - http://localhost:1337/departments/offices
//    @GetMapping("/departments/{id}/offices")
//    public CollectionModel<DepartmentDto> getOfficesInDepartmentById(@PathVariable("id") int id) {
//        if (departmentRepo.existsById(id))
//            return departmentDtoMapper.toCollectionModel(officeRepo.findAllByDepartmentId(id));
//        throw new ResponseStatusException(HttpStatus.NOT_FOUND, "Department id {" + id + "} not found");
//    }
